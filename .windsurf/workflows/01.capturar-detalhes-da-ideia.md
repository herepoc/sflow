...
Entender profundamente a visão do cliente sobre o problema a ser enderaçado e quem é o público alvo.
...
- Deverá esclarecer qual o problema que buscamos resolver
    - Se já foi feito algum protótipo, validação, ou estagio da solucão.
    - Se a solução terá que conectar em sistemas existentes. ou usará aplicações prontas para acelerar o desenvolvimento.
